...
local get_original_lines = function(opts)
  local original_head_text = git.get_file_revision({
    file_name = opts.new_file_focused and opts.new_file_name or opts.old_file_name,
...
local determine_imply_local = function(opts)
  ...
  if not opts.new_file_focused then
...
M.show_preview = function(opts)
  ...
  local commented_file_name = opts.new_file_focused and opts.new_file_name or opts.old_file_name
