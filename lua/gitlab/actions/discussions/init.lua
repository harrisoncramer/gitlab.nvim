...
M.suggestion_preview = function(tree, action)
  ...
  local start_line, new_file_focused, end_line = common.get_line_number_from_node(root_node)
  ...
  if action == "apply" and not new_file_focused then
...
---@param tree NuiTree
---@param override? boolean If not nil, set resolved to `override` value instead of toggling.
